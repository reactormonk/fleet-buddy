...
var _Fresheyeball$elm_tuple_extra$Tuple2$mapSnd = F2(
	function (f, _p21) {
		var _p22 = _p21;
		return {
			ctor: '_Tuple2',
...
var _Fresheyeball$elm_tuple_extra$Tuple2$map = _Fresheyeball$elm_tuple_extra$Tuple2$mapSnd;
var _Fresheyeball$elm_tuple_extra$Tuple2$mapFst = F2(
	function (f, _p23) {
		var _p24 = _p23;
		return {
			ctor: '_Tuple2',
...
var _user$project$Codec$encodeRegisteredChange = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'old',
				_1: _elm_lang$core$Json_Encode$bool(obj.old)
			},
				{
				ctor: '_Tuple2',
				_0: 'now',
				_1: _elm_lang$core$Json_Encode$bool(obj.now)
			}
			]));
};
var _user$project$Codec$encodeMotdChange = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'old',
				_1: _elm_lang$core$Json_Encode$string(obj.old)
			},
				{
				ctor: '_Tuple2',
				_0: 'now',
				_1: _elm_lang$core$Json_Encode$string(obj.now)
			}
			]));
};
var _user$project$Codec$encodeFreeMoveChange = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
...
var _user$project$Codec$encodeCompressedSquad = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'fleetId',
				_1: _elm_lang$core$Json_Encode$string(obj.fleetId)
			},
				{
				ctor: '_Tuple2',
				_0: 'wingId',
				_1: _elm_lang$core$Json_Encode$string(obj.wingId)
			},
				{
				ctor: '_Tuple2',
				_0: 'squadId',
				_1: _elm_lang$core$Json_Encode$string(obj.squadId)
			},
				{
				ctor: '_Tuple2',
				_0: 'name',
				_1: _elm_lang$core$Json_Encode$string(obj.name)
			}
			]));
};
var _user$project$Codec$encodeCompressedWing = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Codec$encodeCompressedSquad, obj.squadsList))
			}
			]));
};
var _user$project$Codec$encodeCompressedStandardIdentifier_Long_String = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$string(obj.id)
			},
				{
				ctor: '_Tuple2',
				_0: 'name',
...
var _user$project$Codec$encodeFleetWarpChange = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'id',
				_1: _user$project$Codec$encodeCompressedStandardIdentifier_Long_String(obj.id)
			},
				{
				ctor: '_Tuple2',
				_0: 'old',
...
var _user$project$Codec$encodeCompressedLocation = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				_1: A2(
					...
					A2(_elm_lang$core$Maybe$map, _user$project$Codec$encodeCompressedStandardIdentifier_Long_String, obj.solarSystem))
			},
				{
				ctor: '_Tuple2',
				_0: 'station',
				_1: A2(
					_elm_lang$core$Maybe$withDefault,
					_elm_lang$core$Json_Encode$null,
					A2(_elm_lang$core$Maybe$map, _user$project$Codec$encodeCompressedStandardIdentifier_Long_String, obj.station))
			}
			]));
};
var _user$project$Codec$encodeLocationChange = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				ctor: '_Tuple2',
				_0: 'old',
				_1: _user$project$Codec$encodeCompressedLocation(obj.old)
			},
				{
				ctor: '_Tuple2',
				_0: 'now',
				_1: _user$project$Codec$encodeCompressedLocation(obj.now)
			}
			]));
};
var _user$project$Codec$encodeMassLocationChange = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				_0: 'ids',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Codec$encodeCompressedStandardIdentifier_Long_String, obj.ids))
			},
				{
				ctor: '_Tuple2',
				_0: 'old',
...
var _user$project$Codec$encodeShipChange = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				ctor: '_Tuple2',
				_0: 'old',
				_1: _user$project$Codec$encodeCompressedStandardIdentifier_Long_String(obj.old)
			},
				{
				ctor: '_Tuple2',
				_0: 'now',
				_1: _user$project$Codec$encodeCompressedStandardIdentifier_Long_String(obj.now)
			},
				{
				ctor: '_Tuple2',
				_0: 'where',
				_1: _user$project$Codec$encodeCompressedLocation(obj.where_escaped)
			}
			]));
};
var _user$project$Codec$encodeSquadMove = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				ctor: '_Tuple2',
				_0: 'old',
				_1: _user$project$Codec$encodeCompressedSquad(obj.old)
			},
				{
				ctor: '_Tuple2',
				_0: 'now',
				_1: _user$project$Codec$encodeCompressedSquad(obj.now)
			}
			]));
};
var _user$project$Codec$encodeWingMove = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				ctor: '_Tuple2',
				_0: 'old',
				_1: _user$project$Codec$encodeCompressedWing(obj.old)
			},
				{
				ctor: '_Tuple2',
				_0: 'now',
				_1: _user$project$Codec$encodeCompressedWing(obj.now)
			}
			]));
};
var _user$project$Codec$encodeCompressedMember = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				ctor: '_Tuple2',
				_0: 'boosterID',
				_1: _elm_lang$core$Json_Encode$int(obj.boosterID)
			},
				{
				ctor: '_Tuple2',
				_0: 'character',
				_1: _user$project$Codec$encodeCompressedStandardIdentifier_Long_String(obj.character)
			},
				{
				ctor: '_Tuple2',
				_0: 'joinTime',
				_1: _elm_lang$core$Json_Encode$string(
					_justinmimbs$elm_date_extra$Date_Extra$toUtcIsoString(obj.joinTime))
			},
				{
				ctor: '_Tuple2',
				_0: 'roleID',
				_1: _elm_lang$core$Json_Encode$int(obj.roleID)
			},
				{
				ctor: '_Tuple2',
				_0: 'ship',
				_1: _user$project$Codec$encodeCompressedStandardIdentifier_Long_String(obj.ship)
			},
				{
				ctor: '_Tuple2',
				_0: 'solarSystem',
				_1: _user$project$Codec$encodeCompressedStandardIdentifier_Long_String(obj.solarSystem)
			},
				{
				ctor: '_Tuple2',
				_0: 'squadID',
				...
				ctor: '_Tuple2',
				_0: 'takesFleetWarp',
				_1: _elm_lang$core$Json_Encode$bool(obj.takesFleetWarp)
			},
				{
				ctor: '_Tuple2',
				_0: 'wingID',
...
var _user$project$Codec$encodeMemberJoin = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				ctor: '_Tuple2',
				_0: 'now',
				_1: _user$project$Codec$encodeCompressedMember(obj.now)
			}
			]));
};
var _user$project$Codec$encodeMemberPart = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				ctor: '_Tuple2',
				_0: 'old',
				_1: _user$project$Codec$encodeCompressedMember(obj.old)
			}
			]));
};
var _user$project$Codec$encodeFleetEvent = function (obj) {
	var _p0 = function () {
		var _p1 = obj;
		switch (_p1.ctor) {
			case 'FleetEventFleetWarpChange':
				return {
					ctor: '_Tuple2',
					_0: 'FleetWarpChange',
					_1: _user$project$Codec$encodeFleetWarpChange(_p1._0)
				};
			case 'FleetEventFreeMoveChange':
				return {
					ctor: '_Tuple2',
					_0: 'FreeMoveChange',
					_1: _user$project$Codec$encodeFreeMoveChange(_p1._0)
				};
			case 'FleetEventLocationChange':
				return {
					ctor: '_Tuple2',
					_0: 'LocationChange',
					_1: _user$project$Codec$encodeLocationChange(_p1._0)
				};
			case 'FleetEventMassLocationChange':
				return {
					ctor: '_Tuple2',
					_0: 'MassLocationChange',
					_1: _user$project$Codec$encodeMassLocationChange(_p1._0)
				};
			case 'FleetEventMemberJoin':
				return {
					ctor: '_Tuple2',
					_0: 'MemberJoin',
					_1: _user$project$Codec$encodeMemberJoin(_p1._0)
				};
			case 'FleetEventMemberPart':
				return {
					ctor: '_Tuple2',
					_0: 'MemberPart',
					_1: _user$project$Codec$encodeMemberPart(_p1._0)
				};
			case 'FleetEventMotdChange':
				return {
					ctor: '_Tuple2',
					_0: 'MotdChange',
					_1: _user$project$Codec$encodeMotdChange(_p1._0)
				};
			case 'FleetEventRegisteredChange':
				return {
					ctor: '_Tuple2',
					_0: 'RegisteredChange',
					_1: _user$project$Codec$encodeRegisteredChange(_p1._0)
				};
			case 'FleetEventShipChange':
				return {
					ctor: '_Tuple2',
					_0: 'ShipChange',
					_1: _user$project$Codec$encodeShipChange(_p1._0)
				};
			case 'FleetEventSquadMove':
				return {
					ctor: '_Tuple2',
					_0: 'SquadMove',
					_1: _user$project$Codec$encodeSquadMove(_p1._0)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: 'WingMove',
					_1: _user$project$Codec$encodeWingMove(_p1._0)
				};
		}
	}();
	var typefield = _p0._0;
	var inner = _p0._1;
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: typefield, _1: inner}
			]));
};
var _user$project$Codec$encodeCompressedFleet = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				ctor: '_Tuple2',
				_0: 'isFreeMove',
				_1: _elm_lang$core$Json_Encode$bool(obj.isFreeMove)
			},
				{
				ctor: '_Tuple2',
				_0: 'isRegistered',
				_1: _elm_lang$core$Json_Encode$bool(obj.isRegistered)
			},
				{
				ctor: '_Tuple2',
				_0: 'isVoiceEnabled',
				_1: _elm_lang$core$Json_Encode$bool(obj.isVoiceEnabled)
			},
				{
				ctor: '_Tuple2',
				_0: 'motd',
				_1: _elm_lang$core$Json_Encode$string(obj.motd)
			}
			]));
};
var _user$project$Codec$encodeFleetState = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'fleet',
				_1: _user$project$Codec$encodeCompressedFleet(obj.fleet)
			},
				{
				ctor: '_Tuple2',
				_0: 'members',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Codec$encodeCompressedMember, obj.members))
			},
				{
				ctor: '_Tuple2',
				_0: 'wings',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Codec$encodeCompressedWing, obj.wings))
			}
			]));
};
var _user$project$Codec$encodeFleetUpdates = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'state',
				_1: _user$project$Codec$encodeFleetState(obj.state)
			},
				{
				ctor: '_Tuple2',
				_0: 'events',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Codec$encodeFleetEvent, obj.events))
			}
			]));
};
var _user$project$Codec$encodeServerToClient = function (obj) {
	var _p2 = function () {
		var _p3 = obj;
		return {
			ctor: '_Tuple2',
			_0: 'FleetUpdates',
			_1: _user$project$Codec$encodeFleetUpdates(_p3._0)
		};
	}();
	var typefield = _p2._0;
	var inner = _p2._1;
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Codec$encodePing = function (obj) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'foo',
				_1: _elm_lang$core$Json_Encode$string(obj.foo)
			}
			]));
};
var _user$project$Codec$encodeClientToServer = function (obj) {
	var _p4 = function () {
		var _p5 = obj;
		return {
			ctor: '_Tuple2',
			_0: 'Ping',
			_1: _user$project$Codec$encodePing(_p5._0)
		};
	}();
	var typefield = _p4._0;
	var inner = _p4._1;
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Codec$Ping = function (a) {
	return {foo: a};
};
var _user$project$Codec$decodePing = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	_elm_lang$core$Json_Decode$succeed(_user$project$Codec$Ping),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'foo', _elm_lang$core$Json_Decode$string));
var _user$project$Codec$FleetUpdates = F2(
	function (a, b) {
		return {state: a, events: b};
	});
var _user$project$Codec$FleetState = F3(
	function (a, b, c) {
		return {fleet: a, members: b, wings: c};
	});
var _user$project$Codec$CompressedFleet = F5(
	function (a, b, c, d, e) {
		return {fleetId: a, isFreeMove: b, isRegistered: c, isVoiceEnabled: d, motd: e};
	});
var _user$project$Codec$decodeCompressedFleet = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			...
			A2(
				...
				A2(
					_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
					_elm_lang$core$Json_Decode$succeed(_user$project$Codec$CompressedFleet),
					A2(_elm_lang$core$Json_Decode_ops[':='], 'fleetId', _elm_lang$core$Json_Decode$string)),
				A2(_elm_lang$core$Json_Decode_ops[':='], 'isFreeMove', _elm_lang$core$Json_Decode$bool)),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'isRegistered', _elm_lang$core$Json_Decode$bool)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'isVoiceEnabled', _elm_lang$core$Json_Decode$bool)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'motd', _elm_lang$core$Json_Decode$string));
var _user$project$Codec$CompressedMember = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {fleetId: a, boosterID: b, character: c, joinTime: d, roleID: e, ship: f, solarSystem: g, squadID: h, station: i, takesFleetWarp: j, wingID: k};
										};
									};
								};
							};
...
var _user$project$Codec$CompressedStandardIdentifier_Long_String = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _user$project$Codec$decodeCompressedStandardIdentifier_Long_String = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		_elm_lang$core$Json_Decode$succeed(_user$project$Codec$CompressedStandardIdentifier_Long_String),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$string)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string));
var _user$project$Codec$decodeCompressedMember = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
							...
							A2(
								...
								A2(
									...
									A2(
										...
										A2(
											_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
											_elm_lang$core$Json_Decode$succeed(_user$project$Codec$CompressedMember),
											A2(_elm_lang$core$Json_Decode_ops[':='], 'fleetId', _elm_lang$core$Json_Decode$string)),
										A2(_elm_lang$core$Json_Decode_ops[':='], 'boosterID', _elm_lang$core$Json_Decode$int)),
									A2(_elm_lang$core$Json_Decode_ops[':='], 'character', _user$project$Codec$decodeCompressedStandardIdentifier_Long_String)),
								A2(_elm_lang$core$Json_Decode_ops[':='], 'joinTime', _elm_community$json_extra$Json_Decode_Extra$date)),
							A2(_elm_lang$core$Json_Decode_ops[':='], 'roleID', _elm_lang$core$Json_Decode$int)),
						A2(_elm_lang$core$Json_Decode_ops[':='], 'ship', _user$project$Codec$decodeCompressedStandardIdentifier_Long_String)),
					A2(_elm_lang$core$Json_Decode_ops[':='], 'solarSystem', _user$project$Codec$decodeCompressedStandardIdentifier_Long_String)),
				A2(_elm_lang$core$Json_Decode_ops[':='], 'squadID', _elm_lang$core$Json_Decode$string)),
			A2(
				_elm_lang$core$Json_Decode_ops[':='],
				'station',
				_elm_lang$core$Json_Decode$maybe(_user$project$Codec$decodeCompressedStandardIdentifier_Long_String))),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'takesFleetWarp', _elm_lang$core$Json_Decode$bool)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'wingID', _elm_lang$core$Json_Decode$string));
var _user$project$Codec$CompressedWing = F4(
	function (a, b, c, d) {
		return {fleetId: a, wingId: b, name: c, squadsList: d};
	});
var _user$project$Codec$CompressedSquad = F4(
	function (a, b, c, d) {
		return {fleetId: a, wingId: b, squadId: c, name: d};
	});
var _user$project$Codec$decodeCompressedSquad = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			...
			A2(
				_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
				_elm_lang$core$Json_Decode$succeed(_user$project$Codec$CompressedSquad),
				A2(_elm_lang$core$Json_Decode_ops[':='], 'fleetId', _elm_lang$core$Json_Decode$string)),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'wingId', _elm_lang$core$Json_Decode$string)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'squadId', _elm_lang$core$Json_Decode$string)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string));
var _user$project$Codec$decodeCompressedWing = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			...
			A2(
				_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
				_elm_lang$core$Json_Decode$succeed(_user$project$Codec$CompressedWing),
				A2(_elm_lang$core$Json_Decode_ops[':='], 'fleetId', _elm_lang$core$Json_Decode$string)),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'wingId', _elm_lang$core$Json_Decode$string)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string)),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'squadsList',
		_elm_lang$core$Json_Decode$list(_user$project$Codec$decodeCompressedSquad)));
var _user$project$Codec$decodeFleetState = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
			_elm_lang$core$Json_Decode$succeed(_user$project$Codec$FleetState),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'fleet', _user$project$Codec$decodeCompressedFleet)),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'members',
			_elm_lang$core$Json_Decode$list(_user$project$Codec$decodeCompressedMember))),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'wings',
		_elm_lang$core$Json_Decode$list(_user$project$Codec$decodeCompressedWing)));
var _user$project$Codec$FleetWarpChange = F3(
	function (a, b, c) {
		return {id: a, old: b, now: c};
	});
var _user$project$Codec$decodeFleetWarpChange = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
			_elm_lang$core$Json_Decode$succeed(_user$project$Codec$FleetWarpChange),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _user$project$Codec$decodeCompressedStandardIdentifier_Long_String)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'old', _elm_lang$core$Json_Decode$bool)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'now', _elm_lang$core$Json_Decode$bool));
var _user$project$Codec$FreeMoveChange = F2(
	function (a, b) {
		return {old: a, now: b};
	});
var _user$project$Codec$decodeFreeMoveChange = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		_elm_lang$core$Json_Decode$succeed(_user$project$Codec$FreeMoveChange),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'old', _elm_lang$core$Json_Decode$bool)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'now', _elm_lang$core$Json_Decode$bool));
var _user$project$Codec$LocationChange = F3(
	function (a, b, c) {
		return {id: a, old: b, now: c};
	});
var _user$project$Codec$CompressedLocation = F2(
	function (a, b) {
		return {solarSystem: a, station: b};
	});
var _user$project$Codec$decodeCompressedLocation = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		_elm_lang$core$Json_Decode$succeed(_user$project$Codec$CompressedLocation),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'solarSystem',
			_elm_lang$core$Json_Decode$maybe(_user$project$Codec$decodeCompressedStandardIdentifier_Long_String))),
	A2(
		...
		'station',
		_elm_lang$core$Json_Decode$maybe(_user$project$Codec$decodeCompressedStandardIdentifier_Long_String)));
var _user$project$Codec$decodeLocationChange = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
			_elm_lang$core$Json_Decode$succeed(_user$project$Codec$LocationChange),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _user$project$Codec$decodeCompressedStandardIdentifier_Long_String)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'old', _user$project$Codec$decodeCompressedLocation)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'now', _user$project$Codec$decodeCompressedLocation));
var _user$project$Codec$MassLocationChange = F3(
	function (a, b, c) {
		return {ids: a, old: b, now: c};
	});
var _user$project$Codec$decodeMassLocationChange = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
			_elm_lang$core$Json_Decode$succeed(_user$project$Codec$MassLocationChange),
			A2(
				_elm_lang$core$Json_Decode_ops[':='],
				'ids',
				_elm_lang$core$Json_Decode$list(_user$project$Codec$decodeCompressedStandardIdentifier_Long_String))),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'old', _user$project$Codec$decodeCompressedLocation)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'now', _user$project$Codec$decodeCompressedLocation));
var _user$project$Codec$MemberJoin = F2(
	function (a, b) {
		return {id: a, now: b};
	});
var _user$project$Codec$decodeMemberJoin = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		_elm_lang$core$Json_Decode$succeed(_user$project$Codec$MemberJoin),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _user$project$Codec$decodeCompressedStandardIdentifier_Long_String)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'now', _user$project$Codec$decodeCompressedMember));
var _user$project$Codec$MemberPart = F2(
	function (a, b) {
		return {id: a, old: b};
	});
var _user$project$Codec$decodeMemberPart = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		_elm_lang$core$Json_Decode$succeed(_user$project$Codec$MemberPart),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _user$project$Codec$decodeCompressedStandardIdentifier_Long_String)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'old', _user$project$Codec$decodeCompressedMember));
var _user$project$Codec$MotdChange = F2(
	function (a, b) {
		return {old: a, now: b};
	});
var _user$project$Codec$decodeMotdChange = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		_elm_lang$core$Json_Decode$succeed(_user$project$Codec$MotdChange),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'old', _elm_lang$core$Json_Decode$string)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'now', _elm_lang$core$Json_Decode$string));
var _user$project$Codec$RegisteredChange = F2(
	function (a, b) {
		return {old: a, now: b};
	});
var _user$project$Codec$decodeRegisteredChange = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		_elm_lang$core$Json_Decode$succeed(_user$project$Codec$RegisteredChange),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'old', _elm_lang$core$Json_Decode$bool)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'now', _elm_lang$core$Json_Decode$bool));
var _user$project$Codec$ShipChange = F4(
	function (a, b, c, d) {
		return {id: a, old: b, now: c, where_escaped: d};
	});
var _user$project$Codec$decodeShipChange = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			...
			A2(
				_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
				_elm_lang$core$Json_Decode$succeed(_user$project$Codec$ShipChange),
				A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _user$project$Codec$decodeCompressedStandardIdentifier_Long_String)),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'old', _user$project$Codec$decodeCompressedStandardIdentifier_Long_String)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'now', _user$project$Codec$decodeCompressedStandardIdentifier_Long_String)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'where', _user$project$Codec$decodeCompressedLocation));
var _user$project$Codec$SquadMove = F3(
	function (a, b, c) {
		return {id: a, old: b, now: c};
	});
var _user$project$Codec$decodeSquadMove = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
			_elm_lang$core$Json_Decode$succeed(_user$project$Codec$SquadMove),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _user$project$Codec$decodeCompressedStandardIdentifier_Long_String)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'old', _user$project$Codec$decodeCompressedSquad)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'now', _user$project$Codec$decodeCompressedSquad));
var _user$project$Codec$WingMove = F3(
	function (a, b, c) {
		return {id: a, old: b, now: c};
	});
var _user$project$Codec$decodeWingMove = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
			_elm_lang$core$Json_Decode$succeed(_user$project$Codec$WingMove),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _user$project$Codec$decodeCompressedStandardIdentifier_Long_String)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'old', _user$project$Codec$decodeCompressedWing)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'now', _user$project$Codec$decodeCompressedWing));
var _user$project$Codec$ClientToServerPing = function (a) {
	return {ctor: 'ClientToServerPing', _0: a};
};
var _user$project$Codec$decodeClientToServer = _elm_lang$core$Json_Decode$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'Ping',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Codec$ClientToServerPing, _user$project$Codec$decodePing))
		]));
var _user$project$Codec$ServerToClientFleetUpdates = function (a) {
	return {ctor: 'ServerToClientFleetUpdates', _0: a};
};
var _user$project$Codec$FleetEventWingMove = function (a) {
	return {ctor: 'FleetEventWingMove', _0: a};
};
var _user$project$Codec$FleetEventSquadMove = function (a) {
	return {ctor: 'FleetEventSquadMove', _0: a};
};
var _user$project$Codec$FleetEventShipChange = function (a) {
	return {ctor: 'FleetEventShipChange', _0: a};
};
var _user$project$Codec$FleetEventRegisteredChange = function (a) {
	return {ctor: 'FleetEventRegisteredChange', _0: a};
};
var _user$project$Codec$FleetEventMotdChange = function (a) {
	return {ctor: 'FleetEventMotdChange', _0: a};
};
var _user$project$Codec$FleetEventMemberPart = function (a) {
	return {ctor: 'FleetEventMemberPart', _0: a};
};
var _user$project$Codec$FleetEventMemberJoin = function (a) {
	return {ctor: 'FleetEventMemberJoin', _0: a};
};
var _user$project$Codec$FleetEventMassLocationChange = function (a) {
	return {ctor: 'FleetEventMassLocationChange', _0: a};
};
var _user$project$Codec$FleetEventLocationChange = function (a) {
	return {ctor: 'FleetEventLocationChange', _0: a};
};
var _user$project$Codec$FleetEventFreeMoveChange = function (a) {
	return {ctor: 'FleetEventFreeMoveChange', _0: a};
};
var _user$project$Codec$FleetEventFleetWarpChange = function (a) {
	return {ctor: 'FleetEventFleetWarpChange', _0: a};
};
var _user$project$Codec$decodeFleetEvent = _elm_lang$core$Json_Decode$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'FleetWarpChange',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Codec$FleetEventFleetWarpChange, _user$project$Codec$decodeFleetWarpChange)),
			A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'FreeMoveChange',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Codec$FleetEventFreeMoveChange, _user$project$Codec$decodeFreeMoveChange)),
			A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'LocationChange',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Codec$FleetEventLocationChange, _user$project$Codec$decodeLocationChange)),
			A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'MassLocationChange',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Codec$FleetEventMassLocationChange, _user$project$Codec$decodeMassLocationChange)),
			A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'MemberJoin',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Codec$FleetEventMemberJoin, _user$project$Codec$decodeMemberJoin)),
			A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'MemberPart',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Codec$FleetEventMemberPart, _user$project$Codec$decodeMemberPart)),
			A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'MotdChange',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Codec$FleetEventMotdChange, _user$project$Codec$decodeMotdChange)),
			A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'RegisteredChange',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Codec$FleetEventRegisteredChange, _user$project$Codec$decodeRegisteredChange)),
			A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'ShipChange',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Codec$FleetEventShipChange, _user$project$Codec$decodeShipChange)),
			A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'SquadMove',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Codec$FleetEventSquadMove, _user$project$Codec$decodeSquadMove)),
			A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'WingMove',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Codec$FleetEventWingMove, _user$project$Codec$decodeWingMove))
		]));
var _user$project$Codec$decodeFleetUpdates = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		_elm_lang$core$Json_Decode$succeed(_user$project$Codec$FleetUpdates),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'state', _user$project$Codec$decodeFleetState)),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'events',
		_elm_lang$core$Json_Decode$list(_user$project$Codec$decodeFleetEvent)));
var _user$project$Codec$decodeServerToClient = _elm_lang$core$Json_Decode$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'FleetUpdates',
			A2(_elm_lang$core$Json_Decode$map, _user$project$Codec$ServerToClientFleetUpdates, _user$project$Codec$decodeFleetUpdates))
		]));

var _user$project$FleetView$urlBuilder = function (id) {
	return A2(
...
var _user$project$FleetView$send = F2(
	function (model, message) {
		return A2(
			...
			A2(
				...
				0,
				_user$project$Codec$encodeClientToServer(message)));
	});
var _user$project$FleetView$shipTextTemplate = A2(
	_lukewestby$elm_template$Template$withValue,
	function (_) {
		return _.name;
	},
	A2(
		_lukewestby$elm_template$Template$withString,
		'x ',
		A2(
			_lukewestby$elm_template$Template$withValue,
			function (_) {
...
var _user$project$FleetView$imageTemplate = A2(
	_lukewestby$elm_template$Template$withString,
	'_512.png',
	A2(
		_lukewestby$elm_template$Template$withValue,
		...
		_lukewestby$elm_template$Template$template('https://image.eveonline.com/Render/')));
var _user$project$FleetView$renderShip = F2(
	function (ship, count) {
		return A2(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									A2(_lukewestby$elm_template$Template$render, _user$project$FleetView$imageTemplate, ship))
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											A2(
												...
												_user$project$FleetView$shipTextTemplate,
												{
													name: ship.name,
													count: _elm_lang$core$Basics$toString(count)
												}))
										]))
								]))
						]))
...
var _user$project$FleetView$insertOrUpdate = F3(
	function (key, fun, dict) {
		return A3(
			_elm_lang$core$Dict$insert,
			key,
			fun(
...
var _user$project$FleetView$count = function (list) {
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (elem, dict) {
				return A3(
					_user$project$FleetView$insertOrUpdate,
					elem,
					function (count) {
						return A2(_elm_lang$core$Maybe$withDefault, 0, count) + 1;
					},
					dict);
			}),
		_elm_lang$core$Dict$empty,
...
var _user$project$FleetView$view = function (model) {
	var _p0 = model.data;
	if (_p0.ctor === 'Just') {
		var countedShips = A2(
			_elm_lang$core$List$map,
			function (_p1) {
				var _p2 = _p1;
				return A2(
					_user$project$FleetView$renderShip,
					{id: _p2._0._0, name: _p2._0._1},
					_p2._1);
			},
			_elm_lang$core$Dict$toList(
				_user$project$FleetView$count(
					A2(
						_elm_lang$core$List$map,
						function (m) {
							return {ctor: '_Tuple2', _0: m.ship.id, _1: m.ship.name};
						},
						_p0._0.state.members))));
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
...
var _user$project$FleetView$update = F2(
	function (action, model) {
		var _p3 = model.data;
		if (_p3.ctor === 'Just') {
			var _p4 = action;
			if (_p4.ctor === 'FromServer') {
				var _p5 = _p4._0;
				var _p6 = _p5._0;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							data: _elm_lang$core$Maybe$Just(
								{
									state: _p6.state,
									events: A2(
										_elm_lang$core$List$take,
										100,
										A2(_elm_lang$core$Basics_ops['++'], _p6.events, _p3._0.events))
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							data: _elm_lang$core$Maybe$Just(
								{
									state: _p9.state,
									events: A2(_elm_lang$core$List$take, 100, _p9.events)
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _user$project$FleetView$FleetInit = F3(
	function (a, b, c) {
		return {id: a, host: b, protocol: c};
	});
var _user$project$FleetView$FleetSocket = function (a) {
	return {url: a};
};
var _user$project$FleetView$fleetSocket = function (struct) {
	var proto = _elm_lang$core$Native_Utils.eq(struct.protocol, 'http') ? 'ws' : 'wss';
	return _user$project$FleetView$FleetSocket(
		A2(
			_elm_lang$core$Basics_ops['++'],
			proto,
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					struct.host,
					A2(_elm_lang$core$Basics_ops['++'], '/fleet-ws/', struct.id)))));
};
var _user$project$FleetView$init = function (struct) {
	return {
		id: struct.id,
		data: _elm_lang$core$Maybe$Nothing,
		socket: _user$project$FleetView$fleetSocket(struct)
	};
};
var _user$project$FleetView$Model = F3(
	function (a, b, c) {
		return {id: a, socket: b, data: c};
	});
var _user$project$FleetView$FleetModel = F2(
	function (a, b) {
		return {state: a, events: b};
	});
var _user$project$FleetView$InvalidMessage = function (a) {
	return {ctor: 'InvalidMessage', _0: a};
};
var _user$project$FleetView$FromServer = function (a) {
	return {ctor: 'FromServer', _0: a};
};
var _user$project$FleetView$subscriptions = function (model) {
	return A2(
		_elm_lang$websocket$WebSocket$listen,
		model.socket.url,
		function (_p10) {
			return A3(
				...
				_user$project$FleetView$InvalidMessage,
				_user$project$FleetView$FromServer,
				A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Codec$decodeServerToClient, _p10));
		});
};

var _user$project$Landing$parseUrl = function (entered) {
	var reg = _elm_lang$core$Regex$regex('\\d+$');
...
var _user$project$Landing$viewValidation = function (model) {
	var _p0 = _user$project$Landing$parseUrl(model.enteredFleetUrl);
	if (_p0.ctor === 'Just') {
...
var _user$project$Landing$init = {enteredFleetUrl: ''};
var _user$project$Landing$Model = function (a) {
	return {enteredFleetUrl: a};
};
var _user$project$Landing$SwitchToFleet = function (a) {
	return {ctor: 'SwitchToFleet', _0: a};
};
var _user$project$Landing$update = F2(
	function (msg, model) {
		var _p1 = msg;
		if (_p1.ctor === 'EnteredFleetUrl') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{enteredFleetUrl: _p1._0}),
			...
			return {
				...
				_1: A2(
					_elm_lang$core$Maybe$map,
					_user$project$Landing$SwitchToFleet,
					_user$project$Landing$parseUrl(model.enteredFleetUrl))
			};
		}
	});
var _user$project$Landing$FleetUrlSubmit = {ctor: 'FleetUrlSubmit'};
var _user$project$Landing$EnteredFleetUrl = function (a) {
	return {ctor: 'EnteredFleetUrl', _0: a};
};
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$class('ui')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Fleet URL')
									])),
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Attributes$placeholder('Fleet URL from fleet dropdown.'),
										_elm_lang$html$Html_Events$onInput(_user$project$Landing$EnteredFleetUrl)
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							])),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_user$project$Landing$viewValidation(model),
								_elm_lang$html$Html_Events$onClick(_user$project$Landing$FleetUrlSubmit)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
		...
		switch (_p0.ctor) {
			...
			case 'FleetViewModel':
				...
				switch (_p1.ctor) {
					case 'LandingModel':
						return _elm_lang$core$Maybe$Just(
							_user$project$FleetView$urlBuilder(_p2.id));
					case 'FleetViewModel':
						return _elm_lang$core$Basics$not(
							_elm_lang$core$Native_Utils.eq(_p1._0.id, _p2.id)) ? _elm_lang$core$Maybe$Just(
							_user$project$FleetView$urlBuilder(_p2.id)) : _elm_lang$core$Maybe$Nothing;
					default:
						return _elm_lang$core$Maybe$Just(
							_user$project$FleetView$urlBuilder(_p2.id));
				}
...
var _user$project$Main$delta2url = F2(
	function (previous, current) {
		return A2(
			...
			A2(_user$project$Main$delta2builder, previous.view, current.view));
	});
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {view: a, host: b, protocol: c};
	});
var _user$project$Main$Flags = F2(
	function (a, b) {
		return {host: a, protocol: b};
	});
var _user$project$Main$NotFound = {ctor: 'NotFound'};
var _user$project$Main$FleetViewModel = function (a) {
	return {ctor: 'FleetViewModel', _0: a};
};
var _user$project$Main$LandingModel = function (a) {
	return {ctor: 'LandingModel', _0: a};
};
var _user$project$Main$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: {
			view: _user$project$Main$LandingModel(_user$project$Landing$init),
			host: flags.host,
...
var _user$project$Main$switch = function (action) {
	var _p3 = action;
	switch (_p3.ctor) {
		case 'SwitchToLandingPage':
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_user$project$Main$LandingModel(_user$project$Landing$init),
				_elm_lang$core$Native_List.fromArray(
					[]));
		case 'SwitchToFleetPage':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Main$FleetViewModel(
					_user$project$FleetView$init(_p3._0)),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		default:
			return {ctor: '_Tuple2', _0: _user$project$Main$NotFound, _1: _elm_lang$core$Platform_Cmd$none};
	}
};
var _user$project$Main$UrlNotFound = {ctor: 'UrlNotFound'};
var _user$project$Main$SwitchToFleetPage = function (a) {
	return {ctor: 'SwitchToFleetPage', _0: a};
};
var _user$project$Main$SwitchToLandingPage = {ctor: 'SwitchToLandingPage'};
var _user$project$Main$location2page = function (location) {
	return A3(
		...
		_evancz$url_parser$UrlParser$oneOf(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					function (id) {
						return _user$project$Main$SwitchToFleetPage(
							{id: id, host: location.host, protocol: location.protocol});
					},
					A2(
						_evancz$url_parser$UrlParser_ops['</>'],
						_evancz$url_parser$UrlParser$s('fleet'),
						_evancz$url_parser$UrlParser$string)),
					A2(
					_evancz$url_parser$UrlParser$format,
					_user$project$Main$SwitchToLandingPage,
					_evancz$url_parser$UrlParser$s(''))
				])),
		location.href);
};
var _user$project$Main$LandingAction = function (a) {
	return {ctor: 'LandingAction', _0: a};
};
var _user$project$Main$FleetViewAction = function (a) {
	return {ctor: 'FleetViewAction', _0: a};
};
		...
		var _p4 = function () {
			...
			switch (_p5.ctor) {
				case 'LandingModel':
					...
					switch (_p6.ctor) {
						case 'Switch':
							return _user$project$Main$switch(_p6._0);
						case 'FleetViewAction':
							return {
								ctor: '_Tuple2',
								_0: _user$project$Main$LandingModel(_p9),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						default:
							var _p7 = A2(_user$project$Landing$update, _p6._0, _p9);
							if (_p7._1.ctor === 'Just') {
								var _p8 = _p7._1._0;
								return {
									ctor: '_Tuple2',
									_0: _user$project$Main$FleetViewModel(
										_user$project$FleetView$init(
											{id: _p8._0, host: model.host, protocol: model.protocol})),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							} else {
								return {
				...
				case 'FleetViewModel':
					...
					switch (_p10.ctor) {
						case 'Switch':
							return _user$project$Main$switch(_p10._0);
						case 'FleetViewAction':
							return A3(
								_Fresheyeball$elm_tuple_extra$Tuple2$mapEach,
								_user$project$Main$FleetViewModel,
								_elm_lang$core$Platform_Cmd$map(_user$project$Main$FleetViewAction),
								A2(_user$project$FleetView$update, _p10._0, _p11));
						default:
							return {
								ctor: '_Tuple2',
								_0: _user$project$Main$FleetViewModel(_p11),
								_1: _elm_lang$core$Platform_Cmd$none
							};
					}
				default:
					...
					switch (_p12.ctor) {
						case 'Switch':
							return _user$project$Main$switch(_p12._0);
						case 'FleetViewAction':
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								model.view,
...
var _user$project$Main$subscriptions = function (model) {
	...
	switch (_p13.ctor) {
		case 'FleetViewModel':
			return A2(
				_elm_lang$core$Platform_Sub$map,
				_user$project$Main$FleetViewAction,
				_user$project$FleetView$subscriptions(_p13._0));
		case 'LandingModel':
			return _elm_lang$core$Platform_Sub$none;
		default:
			return _elm_lang$core$Platform_Sub$none;
...
var _user$project$Main$view = function (model) {
	...
	switch (_p14.ctor) {
		case 'LandingModel':
			return A2(
				_elm_lang$html$Html_App$map,
				_user$project$Main$LandingAction,
				_user$project$Landing$view(_p14._0));
		case 'FleetViewModel':
			return A2(
				_elm_lang$html$Html_App$map,
				_user$project$Main$FleetViewAction,
				_user$project$FleetView$view(_p14._0));
		default:
			return _elm_lang$html$Html$text('404');
	}
};
var _user$project$Main$Switch = function (a) {
...
var _user$project$Main$location2messages = function (location) {
	return _elm_lang$core$Native_List.fromArray(
		[
			function (_p15) {
			return _user$project$Main$Switch(
				A3(
					_elm_community$result_extra$Result_Extra$mapBoth,
					function (_p16) {
						return _user$project$Main$UrlNotFound;
					},
					_elm_lang$core$Basics$identity,
					_p15));
		}(
			_user$project$Main$location2page(location))
		]);
};
var _user$project$Main$main = {
	main: _rgrempel$elm_route_url$RouteUrl$programWithFlags(
		{delta2url: _user$project$Main$delta2url, location2messages: _user$project$Main$location2messages, init: _user$project$Main$init, update: _user$project$Main$update, view: _user$project$Main$view, subscriptions: _user$project$Main$subscriptions}),
	flags: A2(
		_elm_lang$core$Json_Decode$andThen,
